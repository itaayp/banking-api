defmodule BankingApi.Transactions.HelperTest do
  ...
  describe "Date validation" do
    test "validate_date/2 should return {:ok} when the date is valid" do
      ...
      # Do
      {atom, _success_message} = Helper.validate_date(valid_year, valid_month, "fail message")
    ...
    test "validate_date/2 should return {:error} when the year is invalid" do
      ...
      # Do
      {atom, fail_message} = Helper.validate_date(invalid_year, valid_month, "fail message")
    ...
    test "validate_date/2 should return {:error} when the month is invalid" do
      ...
      # Do
      {atom, fail_message} = Helper.validate_date(valid_year, invalid_month, "fail message")
